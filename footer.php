<footer id="footer">
		<a href="/" class="footer__logo">
			<img src="<?php echo get_template_directory_uri(); ?>/images/common/footer_logo.svg" alt="">
		</a>
		<ul class="flex">
			<li>
		...
		<small class="copy sp">Copyright ©︎ ODOL KIKAKU Corporation. All Rights Reserved.</small>
	</footer>
